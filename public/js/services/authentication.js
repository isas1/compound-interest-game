...
myApp.factory('Authentication', ['$rootScope', '$firebaseAuth', 'FIREBASE_URL', '$location', '$firebaseObject', '$http', '$mdToast',
  ...
  //allows firebase's authentication service with our unique url to be called with a single variable.
    ...
    var config = {
      apiKey: "AIzaSyDXAIU3WyeNU6wjoHRpoFruaZ3MkNXT79Y",
      authDomain: "therichestgraduate.firebaseapp.com",
      databaseURL: "https://therichestgraduate.firebaseio.com",
      projectId: "therichestgraduate",
      storageBucket: "therichestgraduate.appspot.com",
      messagingSenderId: "441976928207"
    };
    //console.log(config);
